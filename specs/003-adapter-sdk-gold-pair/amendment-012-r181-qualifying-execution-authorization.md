...
Canonical Amendment 011 merge:

```text
954635f4ec00ac4dc39a6e72e2d7d896256e3720
```

Canonical post-Amendment-011 deterministic run:

```text
33791303003
```

That run completed successfully on Linux, macOS, and Windows. The recovery provider prerequisite and every other provider/Gold/real-agent marker job remained skipped. Therefore Amendment 011's required post-merge deterministic gate is satisfied.
